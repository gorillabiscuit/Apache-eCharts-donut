      ...
      tooltip: {
        ...
        formatter: (params: {
          ...
          if (name === 'Other') {
            ...
            return (
              '<div style="display:flex;flex-direction:column;justify-content:center;align-items:flex-start;padding:24px;gap:16px;position:relative;width:265px;background:#302B4D;box-shadow:0px 0px 2px rgba(0,0,0,0.24), 0px 12px 24px -4px rgba(0,0,0,0.24);border-radius:16px;">' +
              rows +
              '</div>'
            )
          }
          ...
          return (
            '<div style="display:flex;flex-direction:column;justify-content:center;align-items:flex-start;padding:24px;gap:16px;position:relative;width:291px;background:#302B4D;box-shadow:0px 0px 2px rgba(0,0,0,0.24),0px 12px 24px -4px rgba(0,0,0,0.24);border-radius:16px;">' +
              '<div style="display:flex;flex-direction:row;align-items:center;padding:0;gap:15px;width:100%;height:44px;">' +
                (image
