            ...
            const rows = otherBreakdown
              .map((row) => {
                ...
                return (
                  ...
                  '<div style="display:flex;gap:8px;align-items:center;font-family:\'Public Sans\';font-weight:600;font-size:14px;line-height:22px;color:#fff;">' +
                  row.name + ' <span style="font-family:\'Roboto Mono\';font-weight:700;">' + usd + '</span> <span style="opacity:.8">' + row.percent + '% (' + loansLabel + ')</span></div>' +
