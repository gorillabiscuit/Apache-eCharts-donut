      ...
      tooltip: {
        ...
        formatter: (params: {
          ...
          if (name === 'Other') {
            const rows = otherBreakdown
              .map((row) => {
                ...
                return (
                  ...
                  `<div style=\"display:flex;gap:8px;align-items:center;font-family:'Public Sans';font-weight:600;font-size:14px;line-height:22px;color:#fff;\">${row.name} <span style=\"font-family:'Roboto Mono';font-weight:700;\">${usd}</span> <span style=\"opacity:.8\">${row.percent}% (${loansLabel})</span></div>` +
                  `<div style=\"font-family:'Roboto Mono';font-weight:400;font-size:12px;line-height:18px;color:#637381;\">${row.address}</div>` +
                  '</div>'
                )
              })
              .join('')
            ...
            return (
              '<div style="display:flex;flex-direction:column;justify-content:center;align-items:flex-start;padding:24px;gap:8px;position:relative;width:308px;min-height:154px;background:#302B4D;box-shadow:0px 0px 2px rgba(0,0,0,0.24), 0px 12px 24px -4px rgba(0,0,0,0.24);border-radius:16px;">' +
              rows +
              '</div>'
            )
          }
          ...
          return (
            '<div style="display:flex;flex-direction:column;justify-content:center;align-items:flex-start;padding:24px;gap:16px;position:relative;width:308px;height:154px;background:#302B4D;box-shadow:0px 0px 2px rgba(0,0,0,0.24),0px 12px 24px -4px rgba(0,0,0,0.24);border-radius:16px;">' +
              '<div style="display:flex;flex-direction:row;align-items:center;gap:16px;">' +
                (image
                  ? `<img src=\"${image}\" style=\"width:64px;height:64px;border-radius:32px;object-fit:cover;\" />`
                  : '') +
              ...
              '<div style="display:flex;flex-direction:row;align-items:center;padding:0;gap:8px;width:auto;height:22px;">' +
                ...
                `<div style=\"font-family:'Roboto Mono';font-weight:700;font-size:13px;line-height:22px;color:#FFFFFF;\">${usd} ${percent}% (${loansLabel})</div>` +
              '</div>' +
            '</div>'
          )
        }
